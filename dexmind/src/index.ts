...
class DexMindServer {
  ...
  private async storePennyTrade(args: any) {
    const trade: PennyTrade = {
  ...
  private async findBestPairs(args: any) {
  ...
  private async analyzeGasEfficiency(args: any) {
